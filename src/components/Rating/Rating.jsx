...
function Rating() {
    ...
    return (
        <div className={styles.RatingContainer}>
            <img className={styles.ratingImg} src={ratingList[rating]} alt=""/>
            <button onClick={() => setRating(0)}>Bad</button>
            <button onClick={() => setRating(1)}>Ok</button>
            <button onClick={() => setRating(2)}>Good</button>
            <button onClick={() => setRating(3)}>Super</button>
        </div>
    )
}
