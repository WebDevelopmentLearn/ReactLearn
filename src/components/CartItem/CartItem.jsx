import {Box, Card, CardActions, CardContent, Stack, SvgIcon, Typography} from "@mui/material";
import {StyledButton} from "../StyledButton/StyledButton";

export const CartItem = ({product, removeProduct}) => {
    return (
        <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{
            ...
            <Stack direction="row" gap={4} alignItems="center" >
                <Box sx={{
                    ...
                    <img src={product.image} style={{ width: "164px" }} alt={product.name} />
                </Box>
                <Typography sx={{ width: 240, fontWeight: 400 }} >{product.name}</Typography>
                <Box sx={{ width: 64 }}>
